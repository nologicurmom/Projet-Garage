  ...
  <main>
    <div class="container">
      ...
      <section class="section register min-vh-100 d-flex flex-column align-items-left justify-content-center py-0">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-0 col-md-0  flex-column align-items-left justify-content-left">
              ...
              <div class="card mb-3">
                    ...
                    <form action="inscription" method="get" class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                       <select name="Genre" class="form-select" required id="Genre" >
                    ...
                    <div class="col-12">
                      ...
                      <input type="date" name="Date_de_naissance" class="form-control" id="Date_de_naissance" required>
         ...
         <div class="col-12">
                      <p class="small mb-0">Vous avez deja un compte? <a href="traitement.jsp">Log in</a></p>
                    </div>
