 ...
 * @author ASUS
 */
public class specialiter extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
         ...
         int specialiter = Integer.parseInt(request.getParameter("specialiter"));
       
         e.insererEmployeSpecialiter(idemployer, specialiter);
